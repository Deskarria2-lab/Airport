...
class AirportManagerApp:
    ...
    def add_airport(self):
        try:
            ...
            TryFormat(ap)
            self.airports_list = AddAirport(self.airports_list, ap)
            self.update_airports()
    ...
    def delete_airport(self):
        ...
        self.airports_list = RemoveAirport(self.airports_list, icao)
        self.update_airports()

    def save_airports(self):
        file = filedialog.asksaveasfilename(defaultextension=".txt")
        if file:
            SaveSchengenAirports(self.airports_list, file)

    def plot_airports(self):
        PlotAirport(self.airports_list)

    def map_airports(self):
        MapAirport(self.airports_list)
